...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> handleCustomerNotFound(CustomerNotFoundException ex) {
		...
		return ApiResponseHandler.buildResponse(ApiResponseStatus.ERROR, HttpStatus.NOT_FOUND, ApiMessages.CUSTOMER_NOT_FOUND_MESSAGE, apiError);
	}
	...
	public ResponseEntity<Object> handleAccountNotFound(AccountNotFoundException ex) {
		...
		return ApiResponseHandler.buildResponse(ApiResponseStatus.ERROR, HttpStatus.NOT_FOUND, ApiMessages.ACCOUNT_NOT_FOUND_MESSAGE, apiError);
	}

	@ExceptionHandler(UserNotFoundException.class)
	public ResponseEntity<Object> handleUserNotFound(UserNotFoundException ex) {
		ApiError apiError = new ApiError(LocalDateTime.now(), ex.getMessage(), ApiMessages.USER_NOT_FOUND_ERROR);
		return ApiResponseHandler.buildResponse(ApiResponseStatus.ERROR, HttpStatus.NOT_FOUND, ApiMessages.USER_NOT_FOUND_ERROR, apiError);
	}
	...
	public ResponseEntity<Object> handleInsufficientBalance(InsufficientBalanceException ex) {
		...
		return ApiResponseHandler.buildResponse(ApiResponseStatus.ERROR, HttpStatus.BAD_REQUEST, ApiMessages.INSUFFICIENT_BALANCE_ERROR, apiError);
	}
	...
	public ResponseEntity<Object> handleMissingTransactionDetails(MissingTransactionDetailsException ex) {
		ApiError apiError = new ApiError(LocalDateTime.now(), ex.getMessage(), ApiMessages.MISSING_TRANSACTION_DETAILS_MESSAGE);
		return ApiResponseHandler.buildResponse(ApiResponseStatus.ERROR, HttpStatus.BAD_REQUEST, ApiMessages.MISSING_TRANSACTION_DETAILS_MESSAGE, apiError);
	}
	...
	public ResponseEntity<Object> handleInvalidAmount(InvalidAmountException ex) {
		...
		return ApiResponseHandler.buildResponse(ApiResponseStatus.ERROR, HttpStatus.BAD_REQUEST, ApiMessages.ENTER_VALID_AMOUNT_MESSAGE, apiError);
	}
	...
	public ResponseEntity<Object> handleSourceSameAsTarget(SourceSameAsTargetException ex) {
		...
		return ApiResponseHandler.buildResponse(ApiResponseStatus.ERROR, HttpStatus.BAD_REQUEST, ApiMessages.ENTER_A_VALID_ACCOUNT_NUMBER, apiError);
	}
	...
	public ResponseEntity<Object> handleBadCredentials(BadCredentialsException ex) {
		...
		return ApiResponseHandler.buildResponse(ApiResponseStatus.ERROR, HttpStatus.UNAUTHORIZED, ApiMessages.INVALID_CREDENTIALS_MESSAGE, apiError);
	}
	...
	public ResponseEntity<Object> handleGenericException(Exception ex) {
		...
		return ApiResponseHandler.buildResponse(ApiResponseStatus.ERROR, HttpStatus.INTERNAL_SERVER_ERROR, ApiMessages.INTERNAL_SERVER_ERROR, apiError);
	}
